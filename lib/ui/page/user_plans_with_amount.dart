...
import 'user_plan_amount_detail_coin.dart';

class UserPlansAmountPage extends StatefulWidget {
  UserPlansAmountPage({Key key}) : super(key: key);
...
//  PlanListPage(this._myHomePageState, {Key key}) : super(key: key);
  ...
  @override
  _UserPlansAmountPageState createState() => _UserPlansAmountPageState();
}
...
//  List<dynamic> list;
  ...
  try {
    var response =
    await SharedService.dio.get("/getUserPlansWithAmount");
...
class _UserPlansAmountPageState extends State<UserPlansAmountPage> {
                          ...
                          onTap: () {
                            Navigator.push(context,
                                MaterialPageRoute(builder: (BuildContext context) {
                                  return UserPlansAmountDetailPage(
...
//              itemExtent: MediaQuery.of(context).size.height * 0.28,
            ...
            }):Text("無",style: TextStyle(fontSize: 20, fontWeight: FontWeight.w300)),
//          ),
//          flex: 1,
//        ),
        Divider(
